...
$(document).ready(function(){
    ...
    // Transmit batch modal
    $('#transmit-batch').on('click', function () {
        ...
        <div class="batch-modal-progress">
            <div class="batch-modal-progress-step is-processing">
                <div class="progress" id="progress1"></div>
            </div>
    
            <div class="batch-modal-progress-line"></div>
    
            <div class="batch-modal-progress-step">
        ...
        <div class="batch-modal-progress-label" id="progress-text">Processing order</div>
    </div>
        `);
    ...
    var circle3 = new ProgressBar.Circle('#progress3', {
        ...
        circle1.animate(1, {}, function() {
            $("#progress-text").html('Storing claim in \'batched\'');
             circle2.animate(1, {}, function() {
                $("#progress-text").html('Transmitting to Medicare');
                 circle3.animate(1)
             })
         });
    });
